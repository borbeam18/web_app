...
<body>
<aside class="sidebar w-64 text-white flex flex-col fixed h-screen">
...
<main class="main-content">
  <header class="bg-white border-b border-slate-200 px-8 py-4 flex items-center justify-between sticky top-0 z-10">
    <div>
      <div class="text-xs text-slate-500">ระบบผู้ดูแลระบบ</div>
      <h1 class="text-xl font-bold text-slate-800"><?= $pageTitle ?? 'จัดการผู้ใช้งาน' ?></h1>
    </div>
